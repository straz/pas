...
$subhead = "Management thinking needs to move away from focusing on IT expenses to dealing with total 
transaction costs.";
$body = <<<END

As organisations get ready to make financial commitments for next year, executives are 
questioning whether they should continue to spend more on IT. Many have already voted with 
their feet, for after 50 years of steady growth IT spending has levelled off with few prospects of a 
pick up soon.<p>
...
remaining on the sidelines until the risks become more manageable.<p>
...
strategically irrelevant. The author proposed the following policies:<p>
<ul>
<li> Cut IT budgets
<li> Do not invest in information-technology innovations
<li> Invest only after others have succeeded - follow rather than lead
...
<li> Disregard vendors' innovative offerings because they are suspect for seeking added 
revenues
...
involves decisions that influence how an organisation functions and how it competes.<p>
...
computers.<p>
<h3>Transaction Ratio Analysis</h3>
...
in accounting statements as sales general administrative research and development costs.<p>
...
recession.  It remains to be seen if such improvement will be permanent.<p>

<img src="bettervalue-fig1.gif"><br>
...
<img src="bettervalue-fig2.gif"><br>
...
wonder that the dominant characteristic of all spending was waste.<p>
Why were organisations unable to take advantage of IT capabilities? The explanation is simple. 
Each firm had to organise its IT department, train its managers, educate its executives, develop 
most of its software and integrate vendor offerings with disorderly legacy code. It was easier to 
junk and re-build instead of to accumulate and grow. Vendors and consultants thrived with 
revenues growing faster than IT budgets. Out of total 2002 worldwide IT spending of \$2 trillion the 
vendors and consultants reaped about 30%.<p>
...
investments consumed most of the capital used for acquiring non-financial assets.<p>
...
vendors not the IT department, deliver services that reflect the rapidly dropping costs of IT. <p>
...
from focusing on IT to an examination of total transaction costs.<p>
...
assume the risks of technology obsolescence.<p>
...
transaction-handling capabilities.  <p>
Getting both missions accomplished is only for the swift not the sluggish. <p>

<h3>Action points</h3>
<ul>
<li> Spending growth has levelled off and will not pick up soon
<li> Stagnation is not caused by technology maturity or saturation
<li> The current reluctance to spend is because transaction costs did not fall in most 
cases
<li> Restructuring of IT budgets will enable organisations to move technology risk to 
vendors
<li> Executives must focus on transaction costs, not on IT.
</ul>
<h3>Footnotes</h3>
<ol>
<li> <a href="http://www.strassmann.com/pubs/hbr/carr-letter.shtml">http://www.strassmann.com/pubs/hbr/carr-letter.shtml</a>, or 
<a href="http://harvardbusinessonline.hbsp.harvard.edu/b01/en/files/misc/Web_Letters.pdf">http://harvardbusinessonline.hbsp.harvard.edu/b01/en/files/misc/Web_Letters.pdf</a>
<li> Compustat Global Database, 06/12/2002 with only partial results for FY 2002.  A complete set of financial 
...
<li> The median IT/revenue ratio for US firms is 3.5%. The average SG&A/Revenue ratio for US firms is 19%.
<li> US financial and services firms spend 46% of total expenses on transaction costs. In almost all cases the 
...
<li> $100 compounded at a 27.5% interest rate over 21 years will produce this number.
